    ...
    return (
      <div className="editor-text-sample">
        <div class="editor-ruler" style={{
          ...
          <textarea autoCorrect={false} value={this.props.text + ' While it’s true that the Dutch and Flemish are avid linguists, a little effort on your part to speak the local language will be warmly received as a sign of good-will. Phasellus vulputate lectus erat, id elementum urna commodo eget.'} />
        </div>
      </div>
    );
  }
